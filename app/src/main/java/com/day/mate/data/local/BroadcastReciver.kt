...
import com.day.mate.data.StopAdhanReceiver
...
class AdhanReceiver : BroadcastReceiver() {
    ...
    private fun showAdhanNotification(context: Context, prayer: String, mediaPlayer: MediaPlayer) {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            Log.e("AdhanReceiver", "⛔ Permission POST_NOTIFICATIONS مرفوضة")
        }

        // حفظ الـ MediaPlayer علشان يتقفل لما المستخدم يمسح الإشعار
        StopAdhanReceiver.Companion.currentPlayer = mediaPlayer
    }
}
